...
namespace Desafio_1._2.Models
{
    internal class Attendace
    {
        ...
        public Attendace(Patient p, string data, string horaInicial, string horaFinal)
        {
            Paciente = p;
        ...
        public bool Equals(Attendace? other)
        {
        ...
        public int CompareTo(Attendace? other)
        {
            if (other == null) return 1;

            return DataConsulta.CompareTo(other.DataConsulta);
        }
        public Dictionary<string, List<string>> ValidateData()
        {
